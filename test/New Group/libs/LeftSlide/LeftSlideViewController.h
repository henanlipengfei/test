...
//#ifdef KIsFHD // 全高清屏幕
//#define  kMainPageDistance   67   //打开左侧窗时，中视图(右视图)露出的宽度
//#else // 非全高清屏幕
//#define kMainPageDistance   52   //打开左侧窗时，中视图(右视图)露出的宽度
//#endif

//#define kMainPageScale   0.945  //打开左侧窗时，中视图(右视图）缩放比例
#define kMainPageCenter  CGPointMake(kScreenWidth + kScreenWidth * kMainPageScale / 2.0 - kMainPageDistance, self.view.centerY)  //打开左侧窗时，中视图中心点

#define vCouldChangeDeckStateDistance  (kScreenWidth - kMainPageDistance) / 2.0 - 40 //滑动距离大于此数时，状态改变（关--》开，或者开--》关）
#define vSpeedFloat   1.2    //滑动速度
